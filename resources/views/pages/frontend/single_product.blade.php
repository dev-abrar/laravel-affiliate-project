                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="img_top_left">
                                        <h3>{{$product_info->product_name}}</h3>
                                            <div class="product-desp">{!! $product_info->desp !!}</div>
                                    </div>
                                    <a class='pro_btn' href="{{$product_info->product_link}}" target="_blank">Buy Now</a>
                                    <a class='pro_btn tele' href="" target="_blank"> Telegram</a>
                                    <a class='pro_btn whatsapp' href="" target="_blank"> Contact Us</a>
                                </div>
                            </div>
                        </div>
                    </div>
